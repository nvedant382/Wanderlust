const sampleListings = [
  {
    ...
    // Beachfront cottages are very popular and photo-worthy, so here we use "Trending"
    category: "Trending"
  },
  {
    ...
    country: "United States",
    // A modern city loft is best classified as a "Room"
    category: "Rooms"
  },
  {
  ...
  },
  {
    ...
    location: "Florence",
    country: "Italy",
    // A historic villa in a renowned city can be placed under "Iconic Cities"
  ...
  },
  {
    ...
    location: "Portland",
    country: "United States",
    // A treehouse is an offbeat, nature-centric retreat – "Camping" fits well here
    category: "Camping"
  },
  {
    ...
    location: "Cancun",
    country: "Mexico",
    // A high-end condo on the beach can be seen as "Trending"
    category: "Trending"
  },
  {
    ...
    location: "Lake Tahoe",
    country: "United States",
    // Rustic cabins evoke an outdoorsy vibe; "Camping" is a good match here
    category: "Camping"
  },
  {
    ...
    country: "United States",
    // A sleek penthouse in a bustling city best fits in "Rooms"
    category: "Rooms"
  },
  {
    ...
    location: "Verbier",
    country: "Switzerland",
    // Chalet in the Alps naturally goes under "Mountains"
    category: "Mountains"
  },
  {
    ...
    country: "Tanzania",
    // A safari lodge gives an adventurous vibe, here we use "Camping"
    category: "Camping"
  },
  {
    ...
    location: "Amsterdam",
    country: "Netherlands",
    // With Amsterdam’s heritage, classify it as "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    location: "Fiji",
    country: "Fiji",
    // A private island retreat is quite exclusive and stands out – "Trending" works here
    category: "Trending"
  },
  {
    ...
    // A charming countryside cottage can be popular—assign it "Trending"
    category: "Trending"
  },
  {
    ...
    location: "Boston",
    country: "United States",
    // Boston’s historic architecture fits nicely under "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    location: "Bali",
    country: "Indonesia",
    // A relaxed beachfront property is very popular – "Trending" fits well
    category: "Trending"
  },
  {
    ...
    location: "Banff",
    country: "Canada",
    // With those stunning mountain views, we choose "Mountains"
    category: "Mountains"
  },
  {
    ...
    location: "Miami",
    country: "United States",
    // A stylish apartment in a vibrant city is best classified as "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    location: "Phuket",
    country: "Thailand",
    // A luxurious tropical villa – let's mark it as "Trending"
    category: "Trending"
  },
  {
    ...
    country: "United Kingdom",
    // This one's a castle—easy, assign "Castles"
    category: "Castles"
  },
  {
    ...
    // Dubai’s glamorous city vibe fits "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    location: "Montana",
    country: "United States",
    // A log cabin in a wild setting—"Camping" fits the vibe
    category: "Camping"
  },
  {
    ...
    location: "Mykonos",
    country: "Greece",
    // A glamorous beachfront villa – mark it as "Trending"
    category: "Trending"
  },
  {
    ...
    location: "Costa Rica",
    country: "Costa Rica",
    // A treehouse retreat is very nature-centric – assign "Camping"
    category: "Camping"
  },
  {
    ...
    location: "Charleston",
    country: "United States",
    // Charleston’s historic appeal fits nicely into "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    location: "Tokyo",
    country: "Japan",
    // A sleek, modern apartment in Tokyo is best classified as "Iconic Cities"
    category: "Iconic Cities"
  },
  {
    ...
    country: "United States",
    // A cozy lakeside cabin gives off a "Camping" vibe
    category: "Camping"
  },
  {
    ...
    location: "Maldives",
    country: "Maldives",
    // A luxury villa like this is high-end – mark it as "Trending"
    category: "Trending"
  },
  {
    ...
    location: "Aspen",
    country: "United States",
    // A ski chalet naturally goes under the "Mountains" category
    category: "Mountains"
  },
  {
    ...
    location: "Costa Rica",
    country: "Costa Rica",
    // A secluded beach house is a unique getaway – classify it as "Trending"
    category: "Trending"
  }
];
